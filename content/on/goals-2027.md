...
- **[ <span style="font-size: 10px;background-color: lightcoral;">HEALTH</span> ] Improve overall health by having max 12 weeks with more than 2 alcoholic drinks during 2026.** Completion: <span style="color: green;">2 weeks (on track).</span>
...
- **[ <span style="font-size: 10px;background-color: darkseagreen;">GROWTH</span> <span style="font-size: 10px;background-color: silver;">WORK</span> ] Elevate my AI skills by building an end-to-end AI-powered solution by the Q4.** Completion: <span style="color: green;">No projects done (on track).</span>
