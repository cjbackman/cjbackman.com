...
- Community structures were created; like an AI guild with recurring meetings focused on knowledge sharing, discussing challenges, defining guardrails, and conducting retros on AI usage. Additionally, short knowledge sharing talks (15 minutes) for anyone to share experiments and learnings were established.

## What worked well

- The most successful approach I tried, in terms of adoption (<30% to 90% DAU in a month), was to focus on enabling teams with tools, training, community structures, and mandating experimentation and knowledge sharing rather than specific outcomes or use cases.
...
- Woudn't focus too much on speed metrics. Even with high adoption and measurable quality improvements, the impact on speed (e.g., deployment frequency, PR throughput) didn't materialize. Not terribly suprising given other constraints in the SDLC, like slow reviews and lack of full CI/CD maturity.
